...
export const Home = () => {
    ...
    return (
        <HelmetProvider>
            ...
            <div className="group bg-[#3c170a] p-2 px-8 lg:px-16 xl:px-16 rounded-lg hover:text-orange-700">
                                <NavLink
                                    to="https://wa.me/+971563664115?text=I%20want%20a%20deposit%20for%20a%20game."
                                    target="_blank"
                            ...
                            <div className="group bg-[#3c170a] p-2 px-8 lg:px-16 xl:px-16 rounded-lg hover:text-orange-700">
                                <NavLink
                                    to="https://wa.me/+971563664115?text=I%20want%20to%20withdraw%20from%20my%20balance."
                                    target="_blank"
                                    className="flex items-center justify-start w-full"
                                    // onClick={toggleSidebar}
                                >
